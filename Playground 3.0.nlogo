...
to setup
  ...
  reset-ticks
    ...
    create-objects number-of-objects [
    set color blue
    set shape "circle"
...
to go
select-setting
ask wanderers [ flock wiggle ]
tick
if ticks = 500 [stop]
if ticks = runtime [stop]

  ask objects [ifelse reposition-objects? [setxy object-x object-y][
fd object-speed set heading object-heading]]
end
...
to select-setting
  if setting = 1 [set vision-angle 0 set perspace 0 set nearview 0 set maxview 0 set search-angle 0
set
    exploration-option 2]
  if setting = 2 [set vision-angle 0 set perspace 0 set nearview 0 set maxview 50 set search-angle 0
    set exploration-option 2]
  if setting = 3 [set vision-angle 100 set perspace 0 set nearview 0 set maxview 50 set search-angle
    0 set exploration-option 2]
  if setting = 4 [set vision-angle 100 set perspace 0 set nearview 15 set maxview 50 set search-angle
    0 set exploration-option 2]
  if setting = 5 [set vision-angle 100 set perspace 0 set nearview 15 set maxview 50 set search-angle
    45 set exploration-option 2]
  if setting = 6 [set vision-angle 100 set perspace 0 set nearview 15 set maxview 25 set search-angle
    45 set exploration-option 2]
  if setting = 7 [set vision-angle 100 set perspace 0 set nearview 15 set maxview 25 set search-angle
    45 set exploration-option 1]
  if setting = 8 [set vision-angle 100 set perspace 8 set nearview 15 set maxview 25 set search-angle
45 set exploration-option 2]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"pen-1" 1.0 2 -16777216 true "" "plot count turtles with [color = white]"
"pen-2" 1.0 2 -955883 true "" "plot count turtles with [color = orange]"
"pen-3" 1.0 2 -1184463 true "" "plot count turtles with [color = yellow]"
"pen-4" 1.0 2 -8053223 true "" "plot count turtles with [color = 13]"
